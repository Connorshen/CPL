...
disp('start initial network')

% random group clusters in CPL
disp('random group clusters in CPL')
network.weight_recurrent_CPL = randperm(init_para.numNeurons_CPL);

% set weights between input and CPL
if init_para.flag_herg_inputCPL
    disp('set weights between input and CPL')
